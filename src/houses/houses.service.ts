...
export class HousesService {
  constructor(
    @InjectRepository(HousesData)
    private houseDataRepository: Repository<HousesData>,
  ) {}
  ...
  public async createNewRecord(
    createRecordPayload: CreateHouseDto,
  ): Promise<HousesData> {
...
export class HousesAnswersService {
  constructor(
    @InjectRepository(HousesAnswers)
    private houseAnswersRepository: Repository<HousesAnswers>,
