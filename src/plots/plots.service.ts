...
export class PlotsService {
  constructor(
    @InjectRepository(PlotsData)
    private plotsDataRepository: Repository<PlotsData>,
  ) {}
  ...
  public async createNewRecord(
    createRecordPayload: CreatePlotDto,
  ): Promise<PlotsData> {
...
export class PlotsAnswersService {
  constructor(
    @InjectRepository(PlotsAnswers)
    private plotsAnswersRepository: Repository<PlotsAnswers>,
