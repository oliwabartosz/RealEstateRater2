// TRANSLATION PROMPTS
export const translateDescriptionPrompt = "Translate the following real estate offer from polish to english: {offerDescription}"

export const translateLemma = "Translate the following text from polish to english: {offerLemma}"
